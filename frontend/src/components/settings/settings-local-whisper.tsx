  ...
  return (
    <>
      <div className="flex flex-col gap-3 relative">
        <Label className="text-xs dark:text-white/70 text-slate-900/70">{"Local Whisper Model"}</Label>
...
function ModelsRamRequirements() {
  ...
  return (
    <>
      <p className="text-xs dark:text-white/50 text-slate-900/50 flex items-center gap-1">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-56">
            <Table>
              <TableHeader>
                <TableRow className="text-xs dark:text-white/50 text-slate-900/50">
