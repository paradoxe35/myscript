...
export function GetCachedNotionPageBlocks(arg1:string):Promise<Array<notion.NotionBlock>>;

export function GetConfig():Promise<repository.Config>;

export function GetDeviceSettings():Promise<repository.DeviceSettings>;
...
export function GetPageLanguage(arg1:string):Promise<string>;

export function GetPageReadProgress(arg1:string):Promise<repository.ReadProgress>;
...
export function SaveDeviceSettings(arg1:repository.DeviceSettings):Promise<repository.DeviceSettings>;

export function SaveLocalPage(arg1:repository.Page):Promise<repository.Page>;

export function SavePageReadProgress(arg1:string,arg2:number,arg3:number):Promise<void>;
...
export function SetPageExpanded(arg1:string,arg2:boolean):Promise<void>;

export function SetPageLanguage(arg1:string,arg2:string):Promise<void>;
...
export function UpdateLocalPageTitle(arg1:string,arg2:string):Promise<repository.Page>;
